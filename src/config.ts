...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://maplesakura.tw/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-03-28", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bilibili: {
		vmid: "1712641", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				...
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/1712641",
					external: true,
...
export const profileConfig: ProfileConfig = {
	...
	name: "メープルサクラ",
	bio: "人生の道のりで、思いやりと理解、そして寛容さを持てたら、毎日はもっと温かく、穏やかになる。",
	typewriter: {
		enable: true, // 啟用個人簡介打印效果
		speed: 80, // 打字速度（毫秒）
	},
	links: [
		{
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "ブログへようこそ！これはサンプルの告知です", // 公告內容
